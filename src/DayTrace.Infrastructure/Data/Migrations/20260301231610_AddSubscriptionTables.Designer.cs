...
namespace DayTrace.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260301231610_AddSubscriptionTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DayTrace.Domain.Entities.StarPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("star_payments", (string)null);
                });

            modelBuilder.Entity("DayTrace.Domain.Entities.Subscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DayTrace.Domain.Entities.Summary", b =>
                {
                    ...
                    b.Property<Guid?>("HighlightEventId")
                        .HasColumnType("uuid")
                        .HasColumnName("highlight_event_id");
            ...
            modelBuilder.Entity("DayTrace.Domain.Entities.Summary", b =>
                {
                    b.HasOne("DayTrace.Domain.Entities.Event", "HighlightEvent")
                        .WithMany()
                        .HasForeignKey("HighlightEventId")
